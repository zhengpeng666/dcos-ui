...
import _GroupsActionsModal from '../submodules/groups/components/modals/GroupsActionsModal';
import _UsersActionsModal from '../submodules/users/components/modals/UsersActionsModal';
...
module.exports = (PluginSDK) => {
  ...
  let {FilterHeadline, FilterInputText,
    ...
    ResourceTableUtil, StringUtil, TableUtil} = PluginSDK.get([
      'FilterHeadline',
      'FilterInputText',
  ...
  let GroupsActionsModal = _GroupsActionsModal(PluginSDK);
  let UsersActionsModal = _UsersActionsModal(PluginSDK);
