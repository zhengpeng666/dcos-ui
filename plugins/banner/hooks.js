...
module.exports = (PluginSDK) => {
  ...
  let {IconInfo, DOMUtils} = PluginSDK.get(['IconInfo', 'DOMUtils']);

  const BannerPluginHooks = {
    configuration: {
    ...
    initialize: function () {
      ...
      PluginSDK.Hooks.addFilter('applicationContents',
        this.applicationContents.bind(this)
      );
      PluginSDK.Hooks.addFilter('overlayNewWindowButton',
