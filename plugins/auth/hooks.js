...
import _AccessDeniedPage from './components/AccessDeniedPage';
import ACLAuthConstants from './constants/ACLAuthConstants';
import _Authenticated from './components/Authenticated';
import _LoginPage from './components/LoginPage';
import _UserDropup from './components/UserDropup';

module.exports = (PluginSDK) => {

  let AccessDeniedPage = _AccessDeniedPage(PluginSDK);
  let Authenticated = _Authenticated(PluginSDK);
  let LoginPage = _LoginPage(PluginSDK);
  let UserDropup = _UserDropup(PluginSDK);
  ...
  let AuthPluginHooks = {
    ...
    initialize() {
      PluginSDK.Hooks.addAction('AJAXRequestError', this.AJAXRequestError.bind(this));
      PluginSDK.Hooks.addFilter('sidebarFooter', this.sidebarFooter.bind(this));
      PluginSDK.Hooks.addFilter('openIdentifyModal', this.openIdentifyModal.bind(this));
      PluginSDK.Hooks.addFilter('applicationRoutes', this.applicationRoutes.bind(this));
      PluginSDK.Hooks.addAction('userLogoutSuccess', this.userLogoutSuccess.bind(this));
