...
/**
 * !!!! IMPORTANT !!!!!!
 * This StoreMixin class is imported from https://github.com/dcos/mesosphere-shared-reactjs
 * and MUST be moved back there. But until we have validated that this solution works
 * properly I suggest to keep it here.
 *
 * New usage:
 *
 * class Blah extends StoreMixin(OtherClass) {
 *
 * @param {class} Base - The Base class to extend
 * @returns {class} The base class extended with the Store mixin
 */
var StoreMixin = (Base) => class StoreMixin extends Base {

  // constructor() {
    // super();
  // };

  store_initializeListeners(storeListeners) {
   ...
   */
  store_onStoreChange(storeID, event) {
