...
describe('NetworkingStore', function () {
  ...
  it('should return an instance of UsersList', function () {
    ...
    NetworkingStore.fetchUsers();
    var users = NetworkingStore.get('users');
  ...
  it('should return all of the users it was given', function () {
    Config.useFixtures = true;
    NetworkingStore.fetchUsers();
    var users = NetworkingStore.get('users').getItems();
  ...
  describe('dispatcher', function () {
    ...
    it('dispatches the correct event upon success', function () {
      ...
      NetworkingStore.addChangeListener(EventTypes.ACL_USERS_CHANGE, mockedFn);
      AppDispatcher.handleServerAction({
        type: ActionTypes.REQUEST_ACL_USERS_SUCCESS,
        data: [{gid: 'foo', bar: 'baz'}]
      });
    ...
    it('dispatches the correct event upon error', function () {
      ...
      NetworkingStore.addChangeListener(
